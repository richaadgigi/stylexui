...
export const xuiHideSkeleton = (ele) => {
    setTimeout(function () {
        if(ele !== undefined){
...
export const xuiAnime = (customDefinition) => {
...
export const xuiAnimeStart = (customDefinition) => {
    let xuiCustom = customDefinition;
    if (xuiCustom !== undefined) {
        let el = document.querySelector('[xui-custom="' + xuiCustom + '"]');
        if (el !== null) {
...
export const xuiAnimeEnd = (customDefinition) => {
    let xuiCustom = customDefinition;
    if (xuiCustom !== undefined) {
        let el = document.querySelector('[xui-custom="' + xuiCustom + '"]');
        if (el !== null) {
...
export const xuiTypeWriter = (obj) => {
...
export const xuiScrollOnAnimation = () => {
...
export const xuiModalShow = (name) => {
...
export const xuiModalHide = (name) => {
    let modalName = document.querySelector("[xui-modal=\"" + name + "\"]");
    if (modalName !== null) {
        modalName.removeAttribute("display");
        void modalName.offsetWidth;
